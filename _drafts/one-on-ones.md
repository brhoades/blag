...
Effective one on ones are one of the most important tools a manager has to facilitate employee retention, satisfaction, and development. You either have regular, clear, and effective 1-on-1s or you pay for their absence in the categories above.

# Why I am Writing This

About a year ago, I was given the opportunity to be a manager at Cerner. Before becoming a manager, 1-on-1s were important to me as an engineer. 1-on-1s gave an opportunity to bring topics to my manager that otherwise didn't have an outlet, receive and provide feedback, and track successes and failures throughout the year. I seemed to have lucked out here; I don't think that most managers at Cerner do 1-on-1s. Yet for me, they were the reason I've stayed for 2 years and became a team lead at 2 years.

Now, I'm currently the manager of backlog, a poorly named team that handles high priority client requests while simultaneously on-boarding new engineers (365 days/yr support). I could not have survived the last year and on-boarded 5 new hires without regular, effective 1-on-1s with my reports. Additionally, I see peers that do not value 1-on-1s like I do. I suspect this is due to poor utilization and structure of that time; this is something I can help with.

I am not blind to the traps that managers fall into with 1-on-1s easily:
 ...
 * Only surface-level topics and recent events are discussed.

Any of these can lead to 1-on-1s falling off your calendar with neither report nor manager setting them up again. However, these are all preventable with good structure, bidirectional feedback, a good atmosphere, and less than a dozen hours a month of your time.

## One-on-Ones Are Bidirectional
I've found that lying to my reports about 1-on-1s being their meeting is a great way to drive home what the meeting is for. In general, I really do mean that this is their meeting: they can set the agenda and drive it. Unfortunately, I tend to drive the meeting anyway, provide a recurring calendar event with a room, provision a private 1-on-1 document that acts as minutes, and prepare a great deal for the meeting. We meet twice a month for one hour each, in a private, quiet room with our laptops. In our meeting document we utilize a template for minutes:
...
There are three steadfast rules about feedback:
...
#### Negative Feedback
Negative/constructive feedback is harder for several reasons:
...
Depending on how bad your relationship is, you may want to leave out the agreement part. I've also found that prepping your reports for hard feedback becomes easier if you set expectations in a prior meeting (even the last meeting). Tell them exactly what you expect out of them with some solid metrics. For example:
...
Meet this week; maybe bump your 1-on-1 up on your calendar.

> Report made a mistake you're going to laugh about with them.

Can wait until after vacation.
...
Send them a heartfelt attaboy this week.
...
Behavioral feedback is more difficult; it's second-order feedback which requires taking a step back and looking at trends. Like some poetry, behavioral feedback should have [a rhyme to it](https://en.wikipedia.org/wiki/Metre_(poetry)). You should look for patterns in past feedback which could be brought to their attention. Some real examples:
 ...
 1. Report is siloed into figuring out things on their own, but lacks the skills to answer their own questions / know when to give up. You rescue them and have pointed this out.
...
Of course, it's easy when it's written out like this, but these issues are summaries of problems that spanned multiple months. Once you put the patterns together, you call out set of actions to address this:

 1. *Communication skills*. Specifically: review your documents multiple times prior to sending them out. Run them through a screen reader, note the mistakes you make in a notebook, and check the list of mistakes before you send the next document out. Advise them to read more literature to help improve. This likely extends to verbal communication.
 1. *Time management*. Set clear mid sprint deadlines for stories and decrease the complexity of their stories until they reach it. Force them to front-load their work effort by making them work late. Dig deeper for personal issues which may be distracting.
 1. *Time management*. Pomodoro timer or 15 minute egg timer for time spent investigating. Assign a strong mentor and give them the low-down.
...
Also like poetry, if feedback rhymes too much it stops being good. If your situational and behavioral feedback has a strong rhyme, it's time to move from being a peacetime manager to a wartime manager. This topic deserves its own blog post.

#### Gathering Feedback
Feedback should come easily if you are involved with your report's day-to-day activities. Otherwise, it's quite hard and you must rely on others. Either way, you should be reaching out to your peers and your report's peers with regularity. Gather multiple sources and keep them anonymous to your report; you do not want them to feel like they need to be careful around specific individuals.

Do not ask "Do you have any feedback for \<report\>?" If you get something out of that, it's probably feedback that's been festering. Anyone who responds well to that question was either anticipating it (and has been keeping notes) or has some passive-aggressive truthbomb on their belt. Either way, it's going to be stale. You must ask pointed questions, piecemeal, in a conversation to avoid overwhelming them. Some example questions:
